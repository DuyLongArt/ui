...
const TabNavigation: React.FC<TabNavigationProps> = ({ tabs, user, listTab, defaultTab }) => {
    ...
    return (
        <>
            ...
            <div className="flex bg-white/30 backdrop-blur-md text-white gap-2 m-2 rounded-xl p-1 border border-white/40 w-fit">
                {tabs.map((tab) => {
                    ...
                    return (
                        <button
                            ...
                            className={`px-4 py-1 text-sm font-semibold rounded-lg  text-white! transition-all duration-300
                                ${isActive

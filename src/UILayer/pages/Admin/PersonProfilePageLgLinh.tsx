...
const DetailsSection: React.FC<DetailsSectionProps> = ({ details }) => {
    ...
    return (
        <section className="p-4">
            ...
            {/* About Info Link */}
            <div className="flex items-center text-white hover:text-blue-600 cursor-pointer mt-4 mb-4">
                {/* Dots Icon */}
            ...
            <div className="border-t pt-4">
                <p className="text-sm font-semibold text-white mb-2">Latest Preview</p>
                <div className="flex items-center space-x-2 p-2 rounded-lg bg-gray-50 border">
                    ...
                    <p className="text-sm text-white truncate">Preview of the last post content or shared link...</p>
                </div>
            </div>
        </section>
    );
    ...
    return (
        <section className="p-4 pt-6">
            <div className="flex items-start mb-4">
                ...
                <div>
                    ...
                    <p className="text-sm text-white mt-1">
                        <span className="font-semibold text-white">{user.friends}</span> friends
                        <span className="mx-1">•</span>
                        <span className="font-semibold text-white">{user.mutual}</span> mutual
                    </p>
                </div>
            </div>
            ...
            <div className="flex space-x-2">
                <button className="flex-1 flex items-center justify-center bg-gray-200 text-white font-semibold py-2 px-4 rounded-lg hover:bg-gray-300 transition duration-150">
                    {/* Friends Icon */}
                ...
                <button className="bg-gray-200 text-white font-semibold py-2 px-3 rounded-lg hover:bg-gray-300 transition duration-150">
                    {/* Thumbs Up Icon */}
    ...
    return (
        <div className="bg-gray-100 min-h-screen">
            ...
            <footer className="fixed bottom-0 left-0 right-0 bg-white border-t flex justify-around p-3 max-w-xl mx-auto z-10">
                ...
                <PhotographIcon className="h-7 w-7 text-white hover:text-white cursor-pointer" />
                <UsersIcon className="h-7 w-7 text-white hover:text-white cursor-pointer" />
                <ChatIcon className="h-7 w-7 text-white hover:text-white cursor-pointer" />
                <BellIcon className="h-7 w-7 text-white hover:text-white cursor-pointer" />
            </footer>
        </div>
    );
};

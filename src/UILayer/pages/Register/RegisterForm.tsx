...
const RegisterForm = () => {
    ...
    const inputClasses = "block w-full pl-11 pr-4 py-4 bg-white border-2 border-gray-100 rounded-2xl text-white placeholder-gray-400 focus:outline-none focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all text-base";
                    ...
                    <form onSubmit={submitEvent}>
                        <div className="space-y-6">
                            ...
                            <motion.div variants={itemVariants} className="group relative text-left">
                                ...
                                <div className="relative">
                                    <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                        <Mail className="h-5 w-5 text-white group-focus-within:text-indigo-500 transition-colors" />
                                    </div>
                                    <input
                                        type="email"
                                        value={email}
                            ...
                            <motion.div variants={itemVariants} className="group relative text-left">
                                ...
                                <div className="relative">
                                    <textarea
                                        ...
                                        className="block w-full px-4 py-4 bg-white border-2 border-gray-100 rounded-2xl text-white placeholder-gray-400 focus:outline-none focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all text-base resize-none"
                                    />
                                </div>
                            </motion.div>
                            ...
                            <motion.div variants={itemVariants} className="group relative text-left">
                                ...
                                <div className="relative">
                                    <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                        <Globe className="h-5 w-5 text-white group-focus-within:text-indigo-500 transition-colors" />
                                    </div>
                                    <select
                                        value={country}
                                        onChange={(e) => setCountry(e.target.value as CountryType)}
                                        className="block w-full pl-11 pr-10 py-4 bg-white border-2 border-gray-100 rounded-2xl text-white focus:outline-none focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all text-base appearance-none cursor-pointer"
                                    >
